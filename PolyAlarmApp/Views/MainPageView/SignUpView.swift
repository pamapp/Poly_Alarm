...
struct SignUpView: View {
    ...
    @State private var titles: [String] = [ Strings.phoneNumber, Strings.verification, Strings.code, Strings.letsGo ]
                    ...
                    .overlay(
                        VStack(alignment: .center, spacing: geo.size.height / 12) {
                            ...
                            HStack {
                                ...
                                CustomTextField(curWidth: 200, curHeight: 60, fieldType: true, placeholder: Text(Strings.phoneNumber).foregroundColor(.darkGray).font(.resistMedium(20)), text: $phoneNumderField)
                                    .loginDataStyle()
